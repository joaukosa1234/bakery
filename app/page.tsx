    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Frequently{" "}
            <span style={{ color: "#f0d10b", fontWeight: 500 }}>
              Asked Question
            </span>
          </h1>
          ...
          >
            At Lex Auto Solutions we want to make servicing as simple, and
            hassle free as possible. Below are some frequently asked questions.
            If your question isn&apos;t listed below, please do not hesitate to
            contact our Customer Service team on 604-303-9020.
          </p>
        </div>
      </section>
        ...
        {FAQS.map((faq, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <button
                  onClick={() => setOpenFaqIndex(isOpenFaq ? -1 : index)}
                  style={{
                    width: "110px",
                    height: "110px",
                    border: "none",
      ...
      >
        ...
        >
          ...
          >
            Call:{" "}
            <span style={{ color: "#f0d10b", fontWeight: 700 }}>
              604-303-9020
            </span>
          </div>
